...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$36000$fdnbb7H7wUj9$r1dr916dmTpUJz+B5Ki+dD7gD3oqBrrurUfnKAAD7cs=','2019-02-19 10:17:52.989234',1,'admin','','','',1,1,'2019-02-19 10:16:40.382751');
...
INSERT INTO `badges_badge` VALUES ('contributor','1',''),('publisher','3','');
...
INSERT INTO `Categories_category` VALUES (1,'CS','category/d70e27e6-a4dd-486a-9d13-95e4442ca93b.jpg','2019-02-19 10:26:23.762514',1,2,1,0,NULL);
...
INSERT INTO `Community_community` VALUES (1,'CS','<p>CS</p>','',1,'CS','2019-02-19 10:26:44.112728','cs-2',2,1,2,1,0,1,NULL,'');
...
INSERT INTO `Community_communitymembership` VALUES (1,1,3,1);
...
INSERT INTO `django_admin_log` VALUES (1,'2019-02-19 10:18:19.645878','1','Collaborative Community',1,'[{\"added\": {}}]',91,1),(2,'2019-02-19 10:26:23.775657','1','CS',1,'[{\"added\": {}}]',88,1),(3,'2019-02-19 10:28:28.389681','1','draft',2,'[{\"changed\": {\"fields\": [\"initial\"]}}]',31,1),(4,'2019-02-19 10:28:36.331341','3','publish',2,'[{\"changed\": {\"fields\": [\"final\"]}}]',31,1);
...
INSERT INTO `django_content_type` VALUES (47,'actstream','action'),(48,'actstream','follow'),(1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(30,'authtoken','token'),(86,'badges','badge'),(87,'badges','badgetouser'),(21,'BasicArticle','articles'),(22,'BasicArticle','articleviewlogs'),(88,'Categories','category'),(12,'Community','community'),(13,'Community','communityarticles'),(14,'Community','communitycourses'),(15,'Community','communitygroups'),(16,'Community','communitymedia'),(17,'Community','communitymembership'),(18,'Community','requestcommunitycreation'),(5,'contenttypes','contenttype'),(41,'Course','course'),(42,'Course','links'),(43,'Course','topicarticle'),(44,'Course','topics'),(45,'Course','videos'),(10,'django_comments','comment'),(11,'django_comments','commentflag'),(9,'django_comments_xtd','blacklisteddomain'),(8,'django_comments_xtd','xtdcomment'),(51,'django_nyt','notification'),(49,'django_nyt','notificationtype'),(50,'django_nyt','settings'),(52,'django_nyt','subscription'),(78,'etherpad','etherarticle'),(79,'etherpad','ethercommunity'),(80,'etherpad','ethergroup'),(81,'etherpad','etheruser'),(91,'forum','forum'),(94,'forum_attachments','attachment'),(92,'forum_conversation','post'),(93,'forum_conversation','topic'),(100,'forum_member','forumprofile'),(101,'forum_permission','forumpermission'),(102,'forum_permission','groupforumpermission'),(103,'forum_permission','userforumpermission'),(95,'forum_polls','topicpoll'),(96,'forum_polls','topicpolloption'),(97,'forum_polls','topicpollvote'),(98,'forum_tracking','forumreadtrack'),(99,'forum_tracking','topicreadtrack'),(23,'Group','group'),(24,'Group','grouparticles'),(25,'Group','groupinvitations'),(26,'Group','groupmedia'),(27,'Group','groupmembership'),(82,'Media','media'),(83,'metadata','mediametadata'),(84,'metadata','metadata'),(46,'notifications','notification'),(68,'Reputation','articleflaglogs'),(69,'Reputation','articlescorelog'),(70,'Reputation','articleuserscorelogs'),(71,'Reputation','communityreputaion'),(72,'Reputation','flagreason'),(73,'Reputation','mediaflaglogs'),(74,'Reputation','mediascorelog'),(75,'Reputation','mediauserscorelogs'),(76,'Reputation','resourcescore'),(77,'Reputation','userscore'),(28,'reversion','revision'),(29,'reversion','version'),(6,'sessions','session'),(7,'sites','site'),(33,'social_django','association'),(34,'social_django','code'),(35,'social_django','nonce'),(37,'social_django','partial'),(36,'social_django','usersocialauth'),(89,'taggit','tag'),(90,'taggit','taggeditem'),(85,'TaskQueue','task'),(53,'thumbnail','kvstore'),(19,'UserRolesPermission','favourite'),(20,'UserRolesPermission','profileimage'),(39,'webcontent','faq'),(40,'webcontent','faqcategory'),(38,'webcontent','feedback'),(54,'wiki','article'),(55,'wiki','articleforobject'),(56,'wiki','articleplugin'),(57,'wiki','articlerevision'),(58,'wiki','reusableplugin'),(59,'wiki','revisionplugin'),(60,'wiki','revisionpluginrevision'),(61,'wiki','simpleplugin'),(62,'wiki','urlpath'),(63,'wiki_attachments','attachment'),(64,'wiki_attachments','attachmentrevision'),(66,'wiki_images','image'),(67,'wiki_images','imagerevision'),(65,'wiki_notifications','articlesubscription'),(31,'workflow','states'),(32,'workflow','transitions');
...
INSERT INTO `django_migrations` VALUES (1,'contenttypes','0001_initial','2019-02-19 10:14:01.281893'),(2,'taggit','0001_initial','2019-02-19 10:14:01.338750'),(3,'taggit','0002_auto_20150616_2121','2019-02-19 10:14:01.349124'),(4,'workflow','0001_initial','2019-02-19 10:14:01.396296'),(5,'auth','0001_initial','2019-02-19 10:14:01.612942'),(6,'BasicArticle','0001_initial','2019-02-19 10:14:01.723071'),(7,'BasicArticle','0002_articles_tags','2019-02-19 10:14:01.736091'),(8,'Categories','0001_initial','2019-02-19 10:14:01.801023'),(9,'contenttypes','0002_remove_content_type_name','2019-02-19 10:14:01.849676'),(10,'auth','0002_alter_permission_name_max_length','2019-02-19 10:14:01.874337'),(11,'auth','0003_alter_user_email_max_length','2019-02-19 10:14:01.905671'),(12,'auth','0004_alter_user_username_opts','2019-02-19 10:14:01.916077'),(13,'auth','0005_alter_user_last_login_null','2019-02-19 10:14:01.944986'),(14,'auth','0006_require_contenttypes_0002','2019-02-19 10:14:01.947504'),(15,'auth','0007_alter_validators_add_error_messages','2019-02-19 10:14:01.961035'),(16,'auth','0008_alter_user_username_max_length','2019-02-19 10:14:01.998110'),(17,'Media','0001_initial','2019-02-19 10:14:02.081619'),(18,'Group','0001_initial','2019-02-19 10:14:02.434578'),(19,'Course','0001_initial','2019-02-19 10:14:02.801598'),(20,'Community','0001_initial','2019-02-19 10:14:03.108248'),(21,'Community','0002_auto_20181224_0729','2019-02-19 10:14:03.657782'),(22,'Community','0003_auto_20190204_1241','2019-02-19 10:14:03.684579'),(23,'Community','0004_auto_20190205_1144','2019-02-19 10:14:03.970864'),(24,'Community','0005_community_image_thumbnail','2019-02-19 10:14:04.009092'),(25,'Media','0002_media_medialink','2019-02-19 10:14:04.046600'),(26,'Reputation','0001_initial','2019-02-19 10:14:04.624749'),(27,'TaskQueue','0001_initial','2019-02-19 10:14:04.636072'),(28,'UserRolesPermission','0001_initial','2019-02-19 10:14:04.750096'),(29,'actstream','0001_initial','2019-02-19 10:14:05.043288'),(30,'actstream','0002_remove_action_data','2019-02-19 10:14:05.045656'),(31,'admin','0001_initial','2019-02-19 10:14:05.189629'),(32,'admin','0002_logentry_remove_auto_add','2019-02-19 
(75,'forum_attachments','0001_initial','2019-02-19 10:14:09.691402'),(76,'forum_member','0001_initial','2019-02-19 10:14:09.769962'),(77,'forum_member','0002_auto_20160225_0515','2019-02-19 10:14:09.802371'),(78,'forum_member','0003_auto_20160227_2122','2019-02-19 10:14:09.843247'),(79,'forum_permission','0001_initial','2019-02-19 10:14:10.151262'),(80,'forum_permission','0002_auto_20160607_0500','2019-02-19 10:14:10.357805'),(81,'forum_permission','0003_remove_forumpermission_name','2019-02-19 10:14:10.382554'),(82,'forum_polls','0001_initial','2019-02-19 10:14:10.601496'),(83,'forum_polls','0002_auto_20151105_0029','2019-02-19 10:14:10.757980'),(84,'forum_tracking','0001_initial','2019-02-19 10:14:11.006684'),(85,'forum_tracking','0002_auto_20160607_0502','2019-02-19 10:14:11.192372'),(86,'metadata','0001_initial','2019-02-19 10:14:11.342227'),(87,'notifications','0001_initial','2019-02-19 10:14:11.481002'),(88,'notifications','0002_auto_20150224_1134','2019-02-19 10:14:11.573075'),(89,'notifications','0003_notification_data','2019-02-19 10:14:11.615992'),(90,'notifications','0004_auto_20150826_1508','2019-02-19 10:14:11.661468'),(91,'notifications','0005_auto_20160504_1520','2019-02-19 10:14:11.697172'),(92,'notifications','0006_indexes','2019-02-19 10:14:12.002992'),(93,'reversion','0001_initial','2019-02-19 10:14:12.197761'),(94,'reversion','0002_auto_20141216_1509','2019-02-19 10:14:12.200128'),(95,'reversion','0003_auto_20160601_1600','2019-02-19 10:14:12.202477'),(96,'reversion','0004_auto_20160611_1202','2019-02-19 10:14:12.204562'),(97,'sessions','0001_initial','2019-02-19 10:14:12.221423'),(98,'sites','0002_alter_domain_unique','2019-02-19 10:14:12.237869'),(99,'default','0001_initial','2019-02-19 10:14:12.426719'),(100,'social_auth','0001_initial','2019-02-19 10:14:12.429168'),(101,'default','0002_add_related_name','2019-02-19 10:14:12.523780'),(102,'social_auth','0002_add_related_name','2019-02-19 10:14:12.526951'),(103,'default','0003_alter_email_max_length','2019-02-19 10:14:12.549266'),(104,'social_auth','0003_alter_email_max_length','2019-02-19 10:14:12.551936'),(105,'default','0004_auto_20160423_0400','2019-02-19 10:14:12.584598'),(106,'social_auth','0004_auto_20160423_0400','2019-02-19 10:14:12.595520'),(107,'social_auth','0005_auto_20160727_2333','2019-02-19 10:14:12.609920'),(108,'social_django','0006_partial','2019-02-19 10:14:12.629065'),(109,'social_django','0007_code_timestamp','2019-02-19 10:14:12.650767'),(110,'social_django','0008_partial_timestamp','2019-02-19 10:14:12.675123'),(111,'thumbnail','0001_initial','2019-02-19 10:14:12.687748'),(112,'webcontent','0001_initial','2019-02-19 10:14:12.714601'),(113,'webcontent','0002_auto_20180124_1328','2019-02-19 10:14:12.793064'),(114,'webcontent','0003_auto_20180124_1452','2019-02-19 10:14:12.835147'),(115,'webcontent','0004_delete_faq','2019-02-19 10:14:12.844066'),(116,'webcontent','0005_faq','2019-02-19 10:14:12.856945'),(117,'webcontent','0006_faqcategory','2019-02-19 10:14:12.870699'),(118,'webcontent','0007_remove_faq_category','2019-02-19 10:14:12.887336'),(119,'webcontent','0008_faq_category','2019-02-19 10:14:12.915402'),(120,'webcontent','0009_faq_order','2019-02-19 10:14:12.929132'),(121,'webcontent','0010_remove_faq_order','2019-02-19 10:14:12.949752'),(122,'webcontent','0011_faq_order','2019-02-19 10:14:13.036005'),(123,'webcontent','0012_auto_20180125_1628','2019-02-19 10:14:13.062683'),(124,'webcontent','0013_auto_20180125_1634','2019-02-19 10:14:13.085013'),(125,'webcontent','0014_auto_20180125_1636','2019-02-19 10:14:13.096926'),(126,'webcontent','0015_auto_20180125_1643','2019-02-19 10:14:13.120607'),(127,'wiki','0001_initial','2019-02-19 10:14:14.635537'),(128,'wiki','0002_urlpath_moved_to','2019-02-19 10:14:14.736939'),(129,'wiki_attachments','0001_initial','2019-02-19 10:14:15.148011'),(130,'wiki_attachments','0002_auto_20151118_1816','2019-02-19 10:14:15.174444'),(131,'wiki_images','0001_initial','2019-02-19 10:14:15.358163'),(132,'wiki_images','0002_auto_20151118_1811','2019-02-19 10:14:15.377668'),(133,'wiki_notifications','0001_initial','2019-02-19 10:14:15.497449'),(134,'wiki_notifications','0002_auto_20151118_1811','2019-02-19 10:14:15.511723'),(135,'workflow','0002_auto_20190110_1419','2019-02-19 10:14:15.583437'),(136,'reversion','0001_squashed_0004_auto_20160611_1202','2019-02-19 10:14:15.588072'),(137,'social_django','0002_add_related_name','2019-02-19 10:14:15.590392'),(138,'social_django','0001_initial','2019-02-19 10:14:15.592662'),(139,'social_django','0004_auto_20160423_0400','2019-02-19 10:14:15.594937'),(140,'social_django','0005_auto_20160727_2333','2019-02-19 10:14:15.597092'),(141,'social_django','0003_alter_email_max_length','2019-02-19 10:14:15.599563');
...
INSERT INTO `django_session` VALUES ('m948z3vs2bfzwl315p6bl47qbph5qjt7','','2019-02-19 12:28:37.187117');
...
INSERT INTO `etherpad_ethercommunity` VALUES (1,'g.BKCZJSKS1QhI3CDB',1);
...
INSERT INTO `forum_forum` VALUES (1,'2019-02-19 10:18:19.632954','2019-02-19 10:18:19.632991','Collaborative Community','collaborative-community','','',NULL,0,0,0,NULL,1,'<p></p>',1,2,1,0,NULL,0,0,NULL),(2,'2019-02-19 15:56:44.000000','2019-02-19 15:56:44.000000','CS','cs','<p>CS</p>',NULL,NULL,0,0,0,NULL,1,NULL,1,2,2,0,NULL,0,0,NULL);
...
INSERT INTO `Reputation_communityreputaion` VALUES (1,0,0,0,1,1);
...
INSERT INTO `wiki_article` VALUES (1,'2019-02-19 10:18:33.615810','2019-02-19 10:18:33.833550',1,1,1,1,1,NULL,NULL),(2,'2019-02-19 15:56:44.000000','2019-02-19 15:56:44.000000',1,1,1,1,2,1,2);
...
INSERT INTO `wiki_articlerevision` VALUES (1,1,'','',NULL,'2019-02-19 10:18:33.746171','2019-02-19 10:18:33.746203',0,0,'','Collaborative Community',1,NULL,1),(2,1,'Write your summary here.','','','2019-02-19 15:56:44.000000','2019-02-19 15:56:44.000000',0,0,'Write your content here','CS',2,NULL,2);
...
INSERT INTO `wiki_urlpath` VALUES (1,NULL,1,4,1,0,1,NULL,1,NULL),(2,'CS1',2,3,1,1,2,1,1,NULL);
...
-- Dump completed on 2019-02-19 15:59:10
