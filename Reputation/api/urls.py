...
from .views import FetchCommunityReputation, ArticlePublishScore, ReputationStats, ReputationStatsDetails, FlagReasons, ResourceReports, ReputationScore
...
urlpatterns = [
    ...
    url(r'^reputation_score/$', ReputationScore.as_view())
]
