...
from .models import Community, CommunityMembership, CommunityArticles, CommunityGroups, RequestCommunityCreation, CommunityCourses, CommunityFeeds
...
admin.site.register(CommunityFeeds)
